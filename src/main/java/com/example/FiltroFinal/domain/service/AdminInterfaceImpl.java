...
import com.example.FiltroFinal.domain.exception.AdminIdNotFoundException;
import com.example.FiltroFinal.domain.exception.AdminNotFoundException;
import com.example.FiltroFinal.domain.repository.AdminRepository;
...
@Service
public class AdminInterfaceImpl implements CrudInterface<Admin> {
